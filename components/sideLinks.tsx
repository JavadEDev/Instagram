      ...
      {links.map((link) => {
        ...
        return (
          <Link
            key={link.name}
            className={cn(
              `flex h-[48px] grow items-center justify-center gap-2 rounded-md hover:bg-sky-100 hover:text-blue-600 p-3 text-sm font-medium md:flex-none md:justify-start md:p-2 md:px-3`,
